...
class Util:
    ...
    def __init__(self,
                 ...
                 pending_quality_up=None,
                 played_bitrate=None,
                 played_utility=None,
                 rampup_origin=None,
                 rampup_threshold=None,
                 rampup_time=None,
                 rebuffer_event_count=None,
                 rebuffer_time=None,
                 sustainable_quality=None,
                 throughput=0,
                 total_bitrate_change=None,
                 total_log_bitrate_change=None,
...
def init(
    ...
    util.rampup_threshold = rampup_thresholdInput
    ...
    time = count * util.manifest.segment_time + rebuffer_time + startup_time
    ...
    if verboseInput:
        ...
        print('rebuffer ratio: %f' % (rebuffer_time / util.total_play_time))
        ...
        print('time average score: %f' %
            (to_time_average * (util.played_utility -
                                gamma_p * rebuffer_time / util.manifest.segment_time)))
    ...
    results_dict = {
        ...
        'rebuffer_ratio': rebuffer_time / util.total_play_time,
        ...
        'time_average_score': to_time_average * (util.played_utility - gamma_p * rebuffer_time / util.manifest.segment_time),
